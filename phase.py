def phase2date(phase):
	...
	if phase == 1:
		train_start = '2021-03-23'; test_start = '2024-03-23'
		train_end = '2024-03-22'; test_end = '2024-05-17'
	elif phase == 2:
		train_start = '2021-05-18'; test_start = '2024-05-18'
		train_end = '2024-05-17'; test_end = '2024-08-15'
	elif phase == 3:
		train_start = '2021-08-16'; test_start = '2024-08-16'
		train_end = '2024-08-15'; test_end = '2024-11-15'
	elif phase == 4:
		train_start = '2021-11-16'; test_start = '2024-11-16'
